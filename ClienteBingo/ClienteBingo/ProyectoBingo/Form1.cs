    ...
    public partial class Form1 : Form
    {
        ...
        private void empezar_Click(object sender, EventArgs e)  //Nueva y empezar
        {
            if (nueva == 0)  //Si no esta en ninguna partida
            {
                ...
                //ThreadStart tbote = delegate { atender_bote(); };
                //Thbote = new Thread(tbote);
                //Thbote.Start();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
         ...
         //{
         //    quick--;
         //    timer.Text = quick / 60 + ":" + ((quick % 60) >= 10 ? (quick % 60).ToString() : "0" + (quick % 60));
         //}
        ...
        private void EnableLogIn()  //Habilita botones cuando usuario inicia sesion
        {
            ...
            label6.Invoke(delegado, new object[] { "Has iniciado sesión como: " + conectado });
             ...
             while (true)
             {
                 ...
                 switch (codigo)
                 {
                     ...
                     case 3:  //Mas partidas ganadas
                         ...
                         {
                             servicio1 = "No se han obtenido datos.";
